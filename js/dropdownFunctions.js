...
function makeDropdown(canvas) {
    ...
    positionContainer.id = "simulationSettingsId"; //CSS reasons
...
function setPedroStyle(canvas) {
    ...
    style.innerHTML = `
        ...
        /* width */
        #simulationSettingsId::-webkit-scrollbar{
          width: .5em;
        }

        /* Handle */
        #simulationSettingsId::-webkit-scrollbar-thumb {
          background: #666;
        }

        /* Handle on hover */
        #simulationSettingsId::-webkit-scrollbar-thumb:hover {
          background: #444;
        }
